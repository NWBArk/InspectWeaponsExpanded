...
#ifdef INSPECT_DOF_QUALITY_MEDIUM
static const int SampleCount = 22;
static const float2 Kernel[SampleCount] = 
{
    float2(0,0),
    float2(0.53333336,0),
...
#ifdef INSPECT_DOF_QUALITY_HIGH
...
#ifdef INSPECT_DOF_QUALITY_VERYHIGH
